...
<%
/*
	표현언어 EL(Expression Language)변수의 값을 출력할 때 사용하는 스크립트 언어	4가지 영역에 저장된 값을 출력.
	사용법이 간결하고 예외와 형변환에 관대 합니다.서블릿에서 처리된 결과는 영역을 통해 전달되고 표현언어로 접근하여 쉽게 출력.
...
<br>기존 표현식 : <%=request.getAttribute("requestValue") %>
