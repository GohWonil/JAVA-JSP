...
<!-- Core태그: 변수선언, 조건문, 반복문 등을 대체 하는 태그를 제공 -->
...
<!-- 
 ...
 <h2>자바빈즈 생성 - 생성자를 이용</h2>
 <c:set var="person" value='<%=new Person("GD", 25) %>' scope="request" />
...
<!-- 리스트를 출력하기 위해서 반복문을 사용해봅시다. ( c:forEach 가장 많이 사용됨 )!!!!! -->
<c:forEach var="person" items="<%=list %>" >
 ...
 <h2>Map 컬렉션 이용하기</h2>
 <%
 //다른 타입의 여러가지 값을 저장 하기가 용이함
 //ajax, petch를 이용할 경우 데이터만 전달하기 때문에 
 //스크립트에서 데이터를 파싱하여 화면을 다시 그려줌
